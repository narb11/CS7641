...
if __name__ == '__main__':
    ...
    ds1_data = loader.WhiteWineData(verbose=verbose, seed=seed)
    ds1_name = 'white_wine_data'
    ds1_readable_name = 'White Wine Data'
    ds1_data.load_and_process()

    ds2_data = loader.EpilepsyData(verbose=verbose, seed=seed)
    ds2_name = 'ep_data'
    ds2_readable_name = 'ep Data'
    ds2_data.load_and_process()

    # ds2_data = loader.NurseryData(verbose=verbose, seed=seed)
    # ds2_name = 'nurse_data'
    # ds2_readable_name = 'Nursery Data'
    # ds2_data.load_and_process()

    # ds2_data = loader.WhiteWineData(verbose=verbose, seed=seed)
    # ds2_name = 'white_wine_data'
    # ds2_readable_name = 'White Wine Data'
    # ds2_data.load_and_process()

    # ds2_data = loader.WhiteWineData(verbose=verbose, seed=seed)
    # ds2_name = 'banknote_data'
    # ds2_readable_name = 'banknote'
    # ds2_data.load_and_process()
